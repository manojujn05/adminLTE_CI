...
<button type="button" class="btn btn-info btn-md float-right" data-toggle="modal" data-target="#myModal">Add Album</button>	
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                  ...
                  <?php
                    foreach($albums as $album){
                      ...
                      <tr>
                        <td><?= $album->id ?></td>
                        <td>
<img class="artist_img" src='<?= $album->image_link?>' onerror="this.src='http://denrakaev.com/wp-content/uploads/2015/03/no-image-800x511.png'"   width='100' hight='100' />
                        </td>
                        <td><?= $album->name ?></td>
