...
<button type="button" class="btn btn-info btn-md float-right" data-toggle="modal" data-target="#myModal">Add Song</button>	
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                  ...
                  <?php
                    foreach($songs as $song){
                      ...
                      <tr>
                        <td><?= $song->id ?></td>
                        <td>
 <img class="artist_img" src='<?= $song->image_link?>' onerror="this.src='http://denrakaev.com/wp-content/uploads/2015/03/no-image-800x511.png'"   width='100' hight='100' />
                        </td>
                        <td><?= $song->name ?></td>
                        <td>
                        <a href='<?= $song->audio_link?>' >Audio Link</a>
                        </td>
